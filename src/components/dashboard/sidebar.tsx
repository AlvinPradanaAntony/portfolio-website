    ...
    >
      ...
      <div className={`h-full relative ${isCollapsed ? 'p-3' : 'p-6'}`}>
        ...
        <Button
          ...
          className="absolute -right-3 top-6 w-6 h-6 rounded-full bg-white/20 backdrop-blur-md border border-white/30 dark:bg-black/20 dark:border-white/20 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white z-50"
        >
          {isCollapsed ? (
        ...
        <div className={`absolute bottom-6 ${isCollapsed ? 'left-3 right-3' : 'left-6 right-6'}`}>
          <div className={cn(
            "rounded-xl bg-white/20 backdrop-blur-md border border-white/30 dark:bg-black/20 dark:border-white/20",
            isCollapsed ? "p-2" : "p-4"
          )}>
            <div className={cn(
              "flex items-center",
