...
export function Navbar() {
  ...
  return (
    <>
      ...
      <motion.nav
        className={cn(
          "fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-linear",
          isScrolled ? "px-6 py-3" : "px-0 py-6"
        )}
      ...
      >
        <div
          className={cn(
            ...
            isScrolled
              ? "max-w-4xl mx-auto backdrop-blur-xl bg-white/10 dark:bg-black/10 rounded-full px-8 py-3 border border-white/20 dark:border-white/10"
              : "w-full px-6 py-2"
          )}
          style={{
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center justify-center flex-1 mx-8">
              <div
                className={cn(
                  "flex items-center transition-all duration-500 ease-linear",
                ...
                {navItems.map((item, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={cn(
                        "text-sm font-medium transition-all duration-300 relative px-4 py-2 rounded-full",
                        isActive
